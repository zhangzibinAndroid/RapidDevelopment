package com.zzb.zzblibrary.imageload;
...
import com.zzb.zzblibrary.imageload.transform.GlideCircleTransform;
import com.zzb.zzblibrary.imageload.transform.GlideRoundTransform;
...
public class GlideUtil {
    private static int error = R.mipmap.glide_error_loading;//error图片
    private static int error_circle = R.mipmap.glide_error_loading_round;//error圆形图片

    private static int defaultImage = R.mipmap.glide_loading;//默认显示 加载成功之前的图片
    private static int defaultCircleImage = R.mipmap.glide_error_loading_round;//默认显示 加载成功之前的圆形图片
     ...
     */
    public static void setErrorPic(int drawableRes) {
        GlideUtil.error = drawableRes;
    }
     ...
     * @param drawableRes 图片
     */
    public static void setErrorCirclePic(int drawableRes) {
        GlideUtil.error_circle = drawableRes;
    }
     ...
     * @param drawableRes 图片
     */
    public static void setDefaultImagePic(int drawableRes) {
        GlideUtil.defaultImage = drawableRes;
    }
     ...
     * @param drawableRes 图片
     */
    public static void setDefaultCircleImagePic(int drawableRes) {
        GlideUtil.defaultCircleImage = drawableRes;
    }
