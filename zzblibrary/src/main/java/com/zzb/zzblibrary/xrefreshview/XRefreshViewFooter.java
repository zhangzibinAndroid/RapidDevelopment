...
public class XRefreshViewFooter extends AutoLinearLayout implements IFooterCallBack {
    ...
    private AutoLinearLayout layLoadMore;
    ...
    private void initView(Context context) {
        ...
        layLoadMore = moreView.findViewById(R.id.layLoadMore);
        ...
        AutoUtils.autoSize(mContentView);
    }
