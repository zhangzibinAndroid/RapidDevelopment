...
public class XRefreshViewHeader extends LinearLayout implements IHeaderCallBack {
    ...
    private AutoRelativeLayout xrefreshview_header_text;
    ...
    private void initView(Context context) {
        ...
        xrefreshview_header_text = (AutoRelativeLayout) findViewById(R.id.xrefreshview_header_text);
        ...
        AutoUtils.autoSize(xrefreshview_header_text);
    }
    ...
    public void setRefreshTime(long lastRefreshTime) {
        ...
        if (minutes < 1) {
            ...
            refreshTimeText = XRefreshUtils.format(refreshTimeText, minutes);
        } else if (minutes < 60 * 24) {
            refreshTimeText = resources
                    .getString(R.string.xrefreshview_refresh_hours_ago);
            refreshTimeText = XRefreshUtils.format(refreshTimeText, minutes / 60);
        } else {
            refreshTimeText = resources
                    .getString(R.string.xrefreshview_refresh_days_ago);
            refreshTimeText = XRefreshUtils.format(refreshTimeText, minutes / 60 / 24);
        }
