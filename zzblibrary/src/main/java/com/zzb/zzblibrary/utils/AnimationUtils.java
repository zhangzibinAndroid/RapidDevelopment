...
public final class AnimationUtils {
    ...
    /**
     * 获取一个根据中心点旋转的动画
     * 一个根据中心点旋转的动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    ...
    /**
     * 获取一个透明度渐变动画
     * 一个透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     *
     * @param fromAlpha         开始时的透明度
     * @param toAlpha           结束时的透明度都
     * @param animationListener 动画监听器
    ...
    /**
     * 获取一个由完全显示变为不可见的透明度渐变动画
     * 一个由完全显示变为不可见的透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     *
     * @param animationListener 动画监听器
     */
    ...
    /**
     * 获取一个由不可见变为完全显示的透明度渐变动画
     * 一个由不可见变为完全显示的透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     *
     * @param animationListener 动画监听器
     */
