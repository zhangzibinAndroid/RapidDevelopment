...
public abstract class BaseAutoLayoutActivity extends AutoLayoutActivity implements TitleScrollView.ScrollViewListener, TitleNestedScrollView.ScrollViewListener {
    ...
    protected void initScrollTitle(final View view, int color) {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollTitle.setScrollViewListener(BaseAutoLayoutActivity.this);
            }
        });
    }
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                view.getViewTreeObserver().removeGlobalOnLayoutListener(
                        this);
                imageHeight = view.getHeight();
                titleNestedScrollView.setScrollViewListener(BaseAutoLayoutActivity.this);
            }
        });
    }
