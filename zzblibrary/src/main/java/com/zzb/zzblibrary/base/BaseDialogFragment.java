...
public abstract class BaseDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parentView = inflater.inflate(R.layout.base_dialog_fragment_layout, container, false);
        layParent = parentView.findViewById(R.id.baseDialogFragmentLayout);
        AutoUtils.autoSize(layParent);
        mContext = getActivity();
        LogUtils.setClassName(className);
        childrenView = View.inflate(mContext, getLayoutResId(), null);
        layParent.addView(childrenView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
