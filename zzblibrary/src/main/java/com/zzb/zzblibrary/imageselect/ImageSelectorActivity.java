package com.zzb.zzblibrary.imageselect;
...
import com.zzb.zzblibrary.imageselect.adapter.FolderAdapter;
import com.zzb.zzblibrary.imageselect.adapter.ImageAdapter;
import com.zzb.zzblibrary.imageselect.constant.Constants;
import com.zzb.zzblibrary.imageselect.entry.Folder;
import com.zzb.zzblibrary.imageselect.entry.Image;
import com.zzb.zzblibrary.imageselect.model.ImageModel;
import com.zzb.zzblibrary.imageselect.utils.ImageSelectDateUtils;
...
public class ImageSelectorActivity extends ImageBaseActivity {
    ...
    public static void openFragment(Fragment fragment, int requestCode,
                                    boolean isSingle, int maxSelectCount, ArrayList<String> selected) {
    ...
    public static void openChildFragment(Fragment fragment, int requestCode,
                                    boolean isSingle, int maxSelectCount, ArrayList<String> selected) {
        Intent intent = new Intent(fragment.getActivity(), ImageSelectorActivity.class);
        intent.putExtra(Constants.MAX_SELECT_COUNT, maxSelectCount);
        intent.putExtra(Constants.IS_SINGLE, isSingle);
    ...
    private void changeTime() {
        ...
        if (firstVisibleItem >= 0 && firstVisibleItem < mAdapter.getData().size()) {
            ...
            String time = ImageSelectDateUtils.getImageTime(image.getTime() * 1000);
            tvTime.setText(time);
            showTime();
