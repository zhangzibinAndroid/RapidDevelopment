...
import com.zzb.zzblibrary.imageselect.ClipImageActivity;
import com.zzb.zzblibrary.imageselect.ImageSelectorActivity;
...
public class ImageSelectorUtils {
    ...
    public static void openPhoto(Fragment fragment, int requestCode) {
        openPhoto(fragment, requestCode, false, 0);
    }

    public static void openPhotoActivity(Fragment fragment, int requestCode) {
        openPhotoActivity(fragment, requestCode, false, 0);
    }
    ...
    public static void openPhoto(Fragment fragment, int requestCode, ArrayList<String> selected) {
        openPhoto(fragment, requestCode, false, 0, selected);
    }
    ...
    public static void openPhoto(Fragment fragment, int requestCode,
                                 boolean isSingle, int maxSelectCount) {
        openPhoto(fragment, requestCode, isSingle, maxSelectCount, null);
    }


    public static void openPhotoActivity(Fragment fragment, int requestCode,
                                 boolean isSingle, int maxSelectCount) {
        openPhotoFragment(fragment, requestCode, isSingle, maxSelectCount, null);
    }
    ...
    public static void openPhoto(Fragment fragment, int requestCode,
                                 boolean isSingle, int maxSelectCount, ArrayList<String> selected) {
        ImageSelectorActivity.openChildFragment(fragment, requestCode, isSingle, maxSelectCount, selected);
    }


    public static void openPhotoFragment(Fragment fragment, int requestCode,
                                 boolean isSingle, int maxSelectCount, ArrayList<String> selected) {
        ImageSelectorActivity.openFragment(fragment, requestCode, isSingle, maxSelectCount, selected);
    }
