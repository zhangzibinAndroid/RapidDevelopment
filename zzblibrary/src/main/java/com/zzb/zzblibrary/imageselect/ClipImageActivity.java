...
import com.zzb.zzblibrary.imageselect.utils.ImageUtil;
import com.zzb.zzblibrary.imageselect.utils.ImageSelectStringUtils;
import com.zzb.zzblibrary.imageselect.view.ClipImageView;

import java.io.File;
import java.util.ArrayList;

public class ClipImageActivity extends ImageBaseActivity {
    ...
    private void confirm(Bitmap bitmap) {
        ...
        if (ImageSelectStringUtils.isNotEmptyString(imagePath)) {
