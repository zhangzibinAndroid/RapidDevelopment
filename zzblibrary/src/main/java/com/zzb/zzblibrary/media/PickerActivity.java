...
import com.zzb.zzblibrary.media.adapter.FolderAdapter;
import com.zzb.zzblibrary.media.adapter.MediaGridAdapter;
import com.zzb.zzblibrary.media.adapter.SpacingDecoration;
import com.zzb.zzblibrary.media.data.DataCallback;
import com.zzb.zzblibrary.media.data.ImageLoader;
import com.zzb.zzblibrary.media.data.MediaLoader;
import com.zzb.zzblibrary.media.data.VideoLoader;
import com.zzb.zzblibrary.media.entity.Folder;
import com.zzb.zzblibrary.media.entity.Media;
import com.zzb.zzblibrary.media.utils.MediaScreenUtils;
...
public class PickerActivity extends ImageBaseActivity implements DataCallback,View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(type==PickerConfig.PICKER_IMAGE_VIDEO){
            getLoaderManager().initLoader(type,null,new MediaLoader(PickerActivity.this,this));
    ...
    void createFolderAdapter(){
        ...
        mFolderPopupWindow.setHeight((int)(MediaScreenUtils.getScreenHeight(this)*0.6));
    ...
    public void onClick(View v) {
        ...
        if(id==R.id.btn_back){
            ...
            if(gridAdapter.getSelectMedias().size()<=0){
                ToastUtils.show(this,getString(R.string.select_null));
                return;
            }
