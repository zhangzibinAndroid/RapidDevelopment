package com.zzb.zzblibrary.media.adapter;
...
import com.zzb.zzblibrary.media.utils.MediaFileUtils;
...
public class MediaGridAdapter extends RecyclerView.Adapter<MediaGridAdapter.MyViewHolder> {
    ...
    private MediaFileUtils fileUtils = new MediaFileUtils();
    ...
    int getItemWidth() {
        return (MediaScreenUtils.getScreenWidth(context) / PickerConfig.GridSpanCount) - PickerConfig.GridSpanCount;
    }
        ...
        holder.media_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectMedias.size() >= maxSelect && isSelect < 0) {
                    ToastUtils.show(context,context.getString(R.string.msg_amount_limit));
                } else {
                    if (media.size > maxSize) {
                        ToastUtils.show(context,context.getString(R.string.msg_size_limit) + (MediaFileUtils.fileSize(maxSize)));
                    } else {
